...
const DEMO_ARTISAN: ArtisanProfile = {
  _id: "artisan-001",
  user: {
    _id: "user-001", name: "Fatma Ben Amor", email: "fatma@tirjet.tn",
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&q=80&w=400",
    role: "vendor", isVerified: true, status: "active", createdAt: "2024-04-01T00:00:00.000Z",
  },
  phone: "+216 98 456 789", region: "Gafsa",
  specialty: "Tissage Margoum", availability: "Lun - Sam, 9h - 18h",
  description:
  ...
  isApproved: true, createdAt: "2024-04-01T00:00:00.000Z",
};

const DEMO_PRODUCTS: Product[] = [
  { _id: "p1", title: "Margoum Gafsa Heritage", description: "Tissage ancestral aux motifs géométriques berbères.", price: 850, images: ["https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=700&q=80"], category: "margoum", stock: 2 },
  { _id: "p2", title: "Tapis Berbère Rouge", description: "Laine naturelle teinte à la grenade, motifs de Gafsa.", price: 620, images: ["https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=700&q=80"], category: "tissage", stock: 1 },
  { _id: "p3", title: "Coussin Tissé Main", description: "Laine mérinos, motifs traditionnels amazighs.", price: 180, images: ["https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=700&q=80"], category: "tissage", stock: 5 },
  { _id: "p4", title: "Margoum Contemporain", description: "Fusion moderne et tradition, palette naturelle.", price: 1100, images: ["https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=700&q=80"], category: "margoum", stock: 1 },
  { _id: "p5", title: "Nappe Brodée Gafsa", description: "Coton naturel, broderie main à l'aiguille d'or.", price: 290, images: ["https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=700&q=80"], category: "tissage", stock: 3 },
  { _id: "p6", title: "Kilim Ancestral", description: "Technique kilim, motifs rhombiques berbères.", price: 740, images: ["https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=700&q=80"], category: "margoum", stock: 2 },
];
  ...
  return (
    <motion.article className="artp-prod-card"
      ...
      <div className="artp-prod-card__media">
        ...
        <span className="artp-prod-card__cat">{CATEGORY_LABELS[p.category]}</span>
        <motion.button className={`artp-prod-card__wish${isWished ? " artp-prod-card__wish--on" : ""}`}
      ...
      <div className="artp-prod-card__body">
        <div className="artp-prod-card__top">
          ...
          <span className="artp-prod-card__price">{p.price} TND</span>
        </div>
        <p className="artp-prod-card__desc">{p.description}</p>
        <div className="artp-prod-card__foot">
          <a href={`/boutique/${p._id}`} className="artp-prod-card__cta">Voir la pièce →</a>
          <motion.button
  ...
  return (
    <motion.aside className="artp-info-card"
      ...
      <div className="artp-info-card__stats">
        ...
        <div className="artp-info-card__stat">
          <span className="artp-info-card__stat-n">82</span>
          <span className="artp-info-card__stat-l">Avis</span>
        </div>
        <div className="artp-info-card__stat">
  ...
  return (
    <div className="artp-root">
          ...
          <motion.div className="artp-hero__profile-row"
            ...
            <div className="artp-hero__meta">
              ...
              <div className="artp-hero__sub-row">
                ...
                <span className="artp-hero__sub-item">
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="#f5a623" strokeWidth="0"><path d="M12 2l2 7h7l-5.5 4 2 7L12 16l-5.5 4 2-7L3 9h7z" /></svg>
                  4.6 (82 avis)
                </span>
                <span className="artp-hero__sub-item">
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <div className="artp-filters">
                  {["all", ...categories].map(cat => (
                    <motion.button key={cat}
                      ...
                      {cat === "all" ? "Tout voir" : CATEGORY_LABELS[cat]}
                    </motion.button>
                  ))}
                </div>
              ...
              <motion.div key="about" className="artp-about"
                ...
                <div className="artp-about__split">
                  <div className="artp-about__text">
                    <motion.p className="artp-section-eyebrow" variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>Son histoire</motion.p>
      ...
      <motion.section className="artp-cta-banner"
        ...
        <p className="artp-cta-banner__sub">Partagez votre savoir-faire avec le monde. Rejoignez notre communauté et donnez une vitrine internationale à vos créations.</p>
